...
automaticaly apply those settings. This section lists the environment
variables that are supported by the SDK and the way they are interepreted.
...
is also provided in L</OTEL_RESOURCE_ATTRIBUTES>, then the environment
variable takes precedence. Default: C<unknown_service>.
...
Possible values are listed below, linked to the propagators that they
refer to.

=over

=item L<b3|OpenTelemetry::Propagator::B3> (NYI)

=item L<b3multi|OpenTelemetry::Propagator::B3::Multi> (NYI)

=item L<baggage|OpenTelemetry::Propagator::Baggage>

=item L<jaeger|OpenTelemetry::Propagator::Jaeger> (NYI)

=item L<none|OpenTelemetry::Propagator::None>

=item L<ottrace|OpenTelemetry::Propagator::OTTrace> (NYI)

=item L<tracecontext|OpenTelemetry::Propagator::TraceContext>

=item L<xray|OpenTelemetry::Propagator::XRay> (NYI)
...
=item L<always_on|OpenTelemetry::SDK::Trace::Sampler::AlwaysOn>

=item L<always_off|OpenTelemetry::SDK::Trace::Sampler::AlwaysOff>

=item L<jaeger_remote|OpenTelemetry::SDK::Trace::Sampler::Jaeger::Remote> (NYI)

=item L<traceidratio|OpenTelemetry::SDK::Trace::Sampler::TraceIDRatioBased>

=item L<parentbased_always_on|OpenTelemetry::SDK::Trace::Sampler::ParentBased>

=item L<parentbased_always_off|OpenTelemetry::SDK::Trace::Sampler::ParentBased>

=item L<parentbased_traceidratio|OpenTelemetry::SDK::Trace::Sampler::ParentBased>

=item L<parentbased_jaeger_remote|OpenTelemetry::SDK::Trace::Sampler::ParentBased> (NYI)
...
L</OTEL_EVENT_ATTRIBUTE_COUNT_LIMIT>
...
=item L<otlp|OpenTelemetry::Exporter::OTLP>

=item L<zipkin|OpenTelemetry::Exporter::Zipkin> (NYI)
